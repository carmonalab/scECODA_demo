...
Additionally, **ECODA is much more interpretable** (10-100 cell types) compared
to gene expression (2'000 - 20'000 genes).

In this example, you will see how a dataset without sample separation looks like
and how it compares to a dataset with differentially abundant cell types, in the
cell type compositional and gene expressional space.
...
plot_pca(ecoda_object_DiffAbu, label_col = "condition_id", title = "PCA cell type composition", n_hv_feat_show = 2)
plot_pca(ecoda_object_DiffAbu, slot = "pb", label_col = "condition_id", title = "PCA pseudobulk", n_hv_feat_show = 2)
```
...
plot_pca(ecoda_object_DiffAbu, label_col = "condition_id", title = "PCA cell type composition", n_hv_feat_show = 4)
plot_pca(ecoda_object_DiffAbu, slot = "pb", label_col = "condition_id", title = "PCA pseudobulk", n_hv_feat_show = 4)
```

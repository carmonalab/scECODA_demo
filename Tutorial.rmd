...
SingleCellExperiment object) or from a data frame containing cell
counts or frequencies (in % per sample) with `ecoda()`.
...
-   If you create an ECODA object from a data frame containing relative abundances
...
Yes, we recommended to exclude cell types that introduce technical noise

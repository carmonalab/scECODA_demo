...
reason, zeros are replaced by adding a small pseudocount of + 0.5 to all values
(to not distort ratios) or 2/3 times the smallest value [@martín-fernández2003]
in case the ECODA object was created from a data frame of relative abundances.
